...
## Summary
- 106 nodes · 140 edges · 9 communities
...
3. `KYCField` - 8 edges
4. `scripts` - 6 edges
5. `SessionStatus` - 4 edges
6. `ProgressStep` - 4 edges
7. `SessionData` - 4 edges
8. `lib` - 4 edges
9. `AIAssistPanelProps` - 3 edges
10. `AuditModalProps` - 3 edges
...
### Community 2 - "App.tsx"
Cohesion: 0.18
Nodes (10): App(), CustomerSideModal(), CustomerSideModalProps, FooterControls(), FooterControlsProps, InterpreterModal(), InterpreterModalProps, KYCProgressStrip() (+2 more)
...
Cohesion: 0.26
Nodes (9): AIAssistPanel(), AIAssistPanelProps, AuditModal(), AuditModalProps, EditFieldModal(), EditFieldModalProps, KYCField, SessionData (+1 more)

### Community 5 - "package.json"
Cohesion: 0.18
Nodes (10): name, private, scripts, build, clean, dev, lint, start (+2 more)

### Community 6 - "DemoState"
Cohesion: 0.36
Nodes (6): HeaderBar(), HeaderBarProps, VideoPanel(), VideoPanelProps, DemoState, SessionStatus
