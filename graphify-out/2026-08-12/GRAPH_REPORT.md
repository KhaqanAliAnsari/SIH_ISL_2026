...
## Corpus Check
- 23 files · ~8,561 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 129 nodes · 161 edges · 12 communities (8 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f874c2c1`
...
### Community 2 - "App.tsx"
Cohesion: 0.13
Nodes (19): App(), AIAssistPanel(), AIAssistPanelProps, CustomerSideModal(), CustomerSideModalProps, FooterControls(), FooterControlsProps, HeaderBar() (+11 more)
...
Cohesion: 0.29
Nodes (7): AuditModal(), AuditModalProps, EditFieldModal(), EditFieldModalProps, supabase, KYCField, SessionData
